<?php
  ...
  */
  ...
  define("XBDATA_TYPE_INT",XBDATA_TYPE_INTEGER);
  ...
  define("XBDATA_TYPE_FLAGS",XBDATA_TYPE_INT + XBDATA_INPUT_FLAGS);
  define("XBDATA_TYPE_COLOR",XBDATA_TYPE_INT + XBDATA_INPUT_COLOR);
